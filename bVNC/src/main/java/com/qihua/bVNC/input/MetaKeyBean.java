...
public class MetaKeyBean extends AbstractMetaKeyBean implements Comparable<MetaKeyBean> {
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractMetaKeyBean#getKeyDesc()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractMetaKeyBean#setKeyDesc(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractMetaKeyBean#setKeySym(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractMetaKeyBean#setMetaFlags(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractMetaKeyBean#setMouseButtons(int)
     */
    @Override
