...
public class InputHandlerSingleHanded extends InputHandlerDirectSwipePan {
    ...
    /*
     * (non-Javadoc)
     * @see com.qihua.bVNC.input.InputHandlerDirectSwipePan#getDescription()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.qihua.bVNC.input.InputHandlerDirectSwipePan#getId()
     */
    @Override
    public String getId() {
        return ID;
    ...
    /*
     * (non-Javadoc)
     * @see com.qihua.bVNC.input.InputHandlerGeneric#onSingleTapConfirmed(android.view.MotionEvent)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.qihua.bVNC.input.InputHandlerDirectSwipePan#onScroll(android.view.MotionEvent, android.view.MotionEvent, float, float)
     */
    @Override
